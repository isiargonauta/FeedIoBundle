...
use Debril\FeedIoBundle\Form\ItemType;
...
class ItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DebrilFeedIoBundle:Item')->findAll();

        return $this->render('DebrilFeedIoBundle:Item:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DebrilFeedIoBundle:Item')->find($id);
        ...
        return $this->render('DebrilFeedIoBundle:Item:show.html.twig', array(
            'entity'      => $entity,
